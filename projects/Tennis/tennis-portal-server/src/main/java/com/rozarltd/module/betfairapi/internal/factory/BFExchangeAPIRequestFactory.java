...
public class BFExchangeAPIRequestFactory {
    ...
    public GetAccountStatementReq createGetAccountStatementRequest(String sessionToken, int startRecord, int recordCount) {
    ...
    public GetAccountStatementReq getAccountStatementRequest(String sessionToken,
                                                             Calendar startDate,
                                                             Calendar endDate,
                                                             int startRecord,
                                                             int recordCount) {
